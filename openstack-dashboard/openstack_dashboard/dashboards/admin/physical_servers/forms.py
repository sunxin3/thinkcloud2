...
class CreatePhysicalServerForm(forms.SelfHandlingForm):
    ...
    def __init__(self, *args, **kwargs):
        super(CreatePhysicalServerForm, self).__init__(*args, **kwargs)

    def clean(self):
        data = super(CreatePhysicalServerForm, self).clean()
...
class UpdatePhysicalServerForm(forms.SelfHandlingForm):
